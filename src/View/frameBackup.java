...
public class frameBackup extends javax.swing.JInternalFrame {
	...
	private String dirSave = "C:\\Users\\"+System.getProperty("user.name")+"\\Documents";
	private String dirDump = "V:\\PostgreSQL\\13\\bin\\pg_dump.exe";
	private String nome = "BeerDB";
	...
	private void initComponents() {
		...
		txtDirDump.setText("V:\\PostgreSQL\\13\\bin\\pg_dump.exe");
								...
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										...
										.addGroup(layout.createSequentialGroup()
												...
												.addComponent(btnDirDump, javax.swing.GroupLayout.PREFERRED_SIZE, 30,
														javax.swing.GroupLayout.PREFERRED_SIZE))
										.addGroup(layout.createSequentialGroup()
												.addComponent(txtNome, javax.swing.GroupLayout.PREFERRED_SIZE, 100,
														javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel2)
						.addComponent(txtDirDump, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(btnDirDump))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
	...
	private void btnDirDumpActionPerformed(java.awt.event.ActionEvent evt) {
		// TODO add your handling code here:
		JFileChooser chooser = new JFileChooser(new File("C:\\Users\\"+System.getProperty("user.name")+"\\Documents"));
		...
		if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
			if (!chooser.getSelectedFile().getName().equals("pg_dump.exe")) {
				JOptionPane.showMessageDialog(null, "Arquivo inválido","Inválido!",JOptionPane.ERROR_MESSAGE,new javax.swing.ImageIcon(getClass().getResource("/Imagens/sinal-de-avisox32.png")));
			}
			else {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {                                          
        // TODO add your handling code here:
    	if(txtDirDump.getText().isEmpty() || txtDirSave.getText().isEmpty() || txtNome.getText().isEmpty() || txtSenha.getText().isEmpty() || txtUsuario.getText().isEmpty()) {
    		...
    		if(nomeArquivo == "") {
    			...
    			dirSave = dirSave + "\\" + text + ".sql";
    		}
    		PostgresBackup pkb = new PostgresBackup(dirSave, dirDump, nome, senha, user);
    	}
    }    
	...
	private void btnDirSaveActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
			String text = (String) JOptionPane.showInputDialog(null, "Informe o nome do documento:", "documento",
					...
					new javax.swing.ImageIcon(getClass().getResource("/Imagens/disquetex64.png")), null, "");
			nomeArquivo = text;
			dirSave = chooser.getSelectedFile() + ("\\" + text + ".sql");
